...
class Empresa
{
    ...
    public function imprimirColeccion($colObjetos) {
        $stringCol = "";
        foreach($colObjetos as $objetoCol) {
            $stringCol.= $objetoCol;
        }
        return $stringCol;
    }
    ...
    public function informarSumaVentasNacionales() {
        ...
        $ventasRealizadas = $this->getVentas();
    ...
    {
        $ventasConMotoImportada = [];
        $ventasRealizadas = $this->getVentas();
        foreach ($ventasRealizadas as $venta) {
            $tieneMotoImportada = $venta->informarVentasImportadas();
            if (count($tieneMotoImportada)>0) {
                array_push($ventasConMotoImportada, $venta);
            }
        }
        return $ventasConMotoImportada;
    }
